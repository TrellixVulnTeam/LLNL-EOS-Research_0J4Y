...
class _Region(object):
    ...
    def begin_move_set(self, event):
        ...
        if (xmin != None and xmax != None):
            ...
            self._moving_set_min = event.v - xmin_disp
            self._moving_set_max = xmax_disp - event.v
    ...
    def move_set(self, event):
        ...
        def keep_x_in_region():
            ...
            lowest = event.v - self._moving_set_min
            highest = event.v + self._moving_set_max
            ...
            if lowest < low_limit_disp:
                event.v = low_limit_disp + self._moving_set_min
            if highest > high_limit_disp:
                event.v = high_limit_disp - self._moving_set_max
...
class Regions(object):
    ...
    def attempt_begin_move_point(self, event):
        ...
        """
        region_index = self.get_region_index(event.v, event.y)
